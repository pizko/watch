...
<section class="section section-dark"><div class="container contact-grid"><div class="reveal"><div class="eyebrow">Петровка · Москва</div><h2 class="display display-lg contact-title one-line">Мастерская на Петровке.</h2></div><div class="reveal"><dl class="contact-panel"><div class="contact-line"><dt>Адрес</dt><dd>{ADDRESS["postal_code"]}, {ADDRESS_TEXT}</dd></div><div class="contact-line"><dt>График</dt><dd>{HOURS_TEXT}</dd></div><div class="contact-line"><dt>Телефон</dt><dd><a href="{PHONE_HREF}">{PHONE}</a></dd></div></dl><div class="contact-actions"><a class="btn" href="{PHONE_HREF}">Позвонить</a><a class="btn ghost" href="contacts/">Контакты</a></div></div></div></section>
</main>'''
home_schema = [
